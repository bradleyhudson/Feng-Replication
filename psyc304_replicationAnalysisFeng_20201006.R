...
feng_comp_b1 <- feng_clean %>%
  filter(booklet_assign == 1 & comprehension_q == 'y') %>% # to keep rows with responses to comprehension questions
  filter(booklet_assign == 1 & passage == 1 & line != "5") # to keep rows with probe-specific comprehension questions - passage 1 
  filter(booklet_assign == 1 & passage == 2 & line != "3")
  filter(booklet_assign == 1 & passage == 2 & line != "4")
  filter(booklet_assign == 1 & passage == 3 & line != "3")
  filter(booklet_assign == 1 & passage == 3 & line != "4")
  filter(booklet_assign == 1 & passage == 5 & line != "3")
  filter(booklet_assign == 1 & passage == 6 & line != "3") # Num_probs = 5 and number of Qs = 4. Numbers match for other passages.
  filter(booklet_assign == 1 & passage == 7 & line != "1")
  filter(booklet_assign == 1 & passage == 7 & line != "4")
  filter(booklet_assign == 1 & passage == 8 & line != "4") 
...
vec_Sen_Num_b1 <- rep(c(1:7,1:2,1:2,1:4,1:3,1:5,1:2,1:3), times = 92)
